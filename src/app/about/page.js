...
<p>The site's message boards were disabled in February 2017. As of 2019, IMDb was the 52nd most visited website on the Internet, as ranked by Alexa.[3]</p>

<p>As of March 2022, the database contained some 10.1 million titles (including television episodes), 11.5 million person records, and 83 million registered users.[4]</p>

<h3>Features</h3>
<p>The title and talent pages of IMDb are accessible to all users, but only registered and logged-in users can submit new material and suggest edits to existing entries. Most of the site's data has been provided by these volunteers. Registered users with a proven track record are able to add and make corrections to cast lists, credits, and some other data points. However, the addition and removal of images, and alterations to titles, cast and crew names, character names, and plot summaries are subject to an approval process; this usually takes between 24 and 72 hours.</p>

<p>On October 2, 2007,[citation needed] character filmographies were added. Character entries are created from character listings in the main filmography database, and as such do not need any additional verification by IMDb staff. They have already been verified when they are added to the main filmography.</p>

<p>Registered users can choose their username, and most are pseudonymous. There is no single index of contributors, no index on each profile page of the items contributed, and—except for plot synopses and biographies—no identification of contributors to each product's or person's data pages. Users are also invited to rate titles on a scale of 1 to 10, and the totals are converted into a weighted mean-rating, with filters in place to mitigate ballot-stuffing</p>.

<p>User profile pages show a user's registration date and, optionally, their personal ratings of titles. Since 2015, "badges" can be added showing a count of contributions. These badges range from total contributions made to independent categories such as photos, trivia, and biographies. If a registered user or visitor is in the entertainment industry and has an IMDb page, they can add photos through IMDbPRO.[5]</p>

<h3>User ratings of films</h3>
<i>
As one adjunct to data, the IMDb offers a rating scale that allows users to rate titles on a scale of one to ten.</i>

<p>IMDb indicates that submitted ratings are filtered and weighted in various ways to produce a weighted mean that is displayed for each title. It states that filters are used to deter ballot stuffing; the methodology and details for how its ratings are calculated are confidential and not accessible to the public. In fact, it sometimes produces an extreme difference between the weighted average and the arithmetic mean.</p>

<h1>Rankings</h1>
<p>The IMDb Top 250 is a list of the top rated 250 films, based on ratings by the registered users of the website using the methods described. As of 5 September 2023, The Shawshank Redemption, directed by Frank Darabont, is No. 1 on the list, and has been since 2008.[6][7][8] The "Top 250" rating is based on only the ratings of "regular voters". The number of votes a registered user would have to make to be considered as a user who votes regularly has been kept secret. IMDb has stated that to maintain the effectiveness of the Top 250 list they "deliberately do not disclose the criteria used for a person to be counted as a regular voter".[9] In addition to other weightings, the Top 250 films are also based on a weighted rating formula referred to in actuarial science as a credibility formula.[10] This label arises because a statistic is taken to be more credible the greater the number of individual pieces of information; in this case from eligible users who submit ratings. Although the current formula is not disclosed, IMDb originally used the following formula to calculate their weighted rating:[11]</p>
...
On the Web
The database had been expanded to include additional categories of filmmakers and other demographic material as well as trivia, biographies, and plot summaries. The movie ratings had been properly integrated with the list data, and a centralized email interface for querying the database had been created by Alan Jay. Later, in 1993, it moved onto the fledgling World Wide Web under the name of Cardiff Internet Movie Database.[27] The database resided on the servers of the computer science department of Cardiff University in Wales. Rob Hartill was the original web interface author. In 1994, the email interface was revised to accept the submission of all information, which enabled people to email the specific list maintainer with their updates. However, the structure remained so that information received on a single film was divided among multiple section managers, the sections being defined and determined by categories of film personnel and the individual filmographies contained therein. Over the next few years, the database was run on a network of mirrors across the world with donated bandwidth.[28]

As an independent company
In 1996 IMDb was incorporated in the United Kingdom, becoming the Internet Movie Database Ltd. Founder Col Needham became the primary owner. General revenue for site operations was generated through advertising, licensing and partnerships.[29]

As Amazon.com subsidiary (1998–present)
In 1998, Jeff Bezos, founder, owner, and CEO of Amazon.com, struck a deal with Needham and other principal shareholders to buy IMDb outright; Amazon paid $55 million for IMDb and two other companies.[30] Bezos attached it to Amazon as a subsidiary, private company.[31] This gave IMDb the ability to pay the shareholders salaries for their work.[clarify] In the process of expanding its product line, Amazon.com intended to use IMDb as an advertising resource for selling DVDs and videotapes.
...
From 1996 onwards, an annual newsletter email (archived on the website) has been sent from Col Needham to contributors on the first day of each calendar year. The annual newsletter lists various information about the past year on the site, including stats, top contributors tally for the year (the top 300 users, currently; fewer in previous years), and a perspective on the site's progress and future.[32][33][34]

As an additional incentive for users, as of 2003, users identified as one of the "top 100 contributors" of hard data received complimentary free access to IMDbPro for the following calendar year; for 2006 this was increased to the top 150 contributors, and for 2010 to the top 250.[35]

In 2008, IMDb launched their first official foreign-language version with IMDb.de, in German. Also in 2008, IMDb acquired two other companies: Withoutabox[36] and Box Office Mojo.[37]

The website was originally Perl-based, but IMDb no longer discloses what software it uses for reasons of security.[38] In 2010, the site was filtered in China.[39]

In 2016, The IMDb Studio at Sundance was launched, a talk show that is presented on IMDb and YouTube.[40][41]

In April 2017, IMDb celebrated its 25th anniversary. As of that year, Needham was still managing IMDb from its main office in Bristol in the Castlemead office tower.[42]

In January 2019, IMDb launched an ad-supported streaming service called Freedive.[43] This was the company's second attempt at a streaming service; it launched a similar service in 2008.[44][45] In June 2019, Freedive was rebranded as IMDb TV.[46] In April 2022, the service was rebranded again as Amazon Freevee.[47]

Content and format
Data provided by subjects
In 2006, IMDb introduced its "Résumé Subscription Service", where an actor or crew member can post their résumé and upload photos[48] for a yearly fee.[49] IMDb résumé pages are kept on a sub-page of the regular entry about that person, with a regular entry automatically created for each résumé subscriber who does not already have one.[50]
...
Podcasts
On October 21, 2021, the site added the ability to add podcasts (both as series and episodes) as titles to the site, via an IMDb employee announcement on their Sprinklr forums.[60] As of December 2022, the numbers of podcast series stood at 24,778, with podcast episodes at 3,076,386.[4]

Legal and policy issues
In 2011, in the case of Hoang v. Amazon.com, Inc., IMDb was sued by an anonymous actress for at least US$1,075,000 because the movie website publicly disclosed her age (40, at the time) without her consent.[61] The actress claimed that revealing her age could cause her to lose acting opportunities.[62] Judge Marsha J. Pechman, a US district judge in Seattle, dismissed the lawsuit, saying the actress had no grounds to proceed with an anonymous complaint. The actress re-filed and so revealed that she was Huong Hoang of Texas, who uses the stage name Junie Hoang.[63] In 2013, Pechman dismissed all causes of action except for a breach of contract claim against IMDb; a jury then sided with IMDb on that claim.[64] The Court of Appeals for the Ninth Circuit affirmed the district court judgment in March 2015.[65]

Also in 2011, in the case of United Video Properties Inc., et al. v. Amazon.Com Inc. et al.,[66] IMDb and Amazon were sued by Rovi Corporation and others for patent infringement over their various program listing offerings.[67] The patent claims were ultimately construed in a way favorable to IMDb, and Rovi / United Video Properties lost the case.[68] In April 2014, the decision was affirmed by the U.S. Court of Appeals.[69]

On January 1, 2017, the State of California implemented state bill AB-1687, a SAG-AFTRA-backed anti-ageism statute which requires "commercial online entertainment employment services" to honor requests by their subscribers for their ages and birthdays to be hidden.[70] By the beginning of 2017, IMDb had received more than 2,300 requests from individuals to remove their date of birth from the site. Included in this group were 10 Academy Award winners and another 71 nominated for Oscars, Emmys, or Golden Globes.[71] On February 23, 2017, Judge Vince Girdhari Chhabria issued a stay on the bill pending a further trial, claiming that it possibly violated the First Amendment because it inhibited the public consumption of information. He also questioned the intent of the bill, as it was ostensibly meant to target IMDb.[72]

IMDb had long maintained that it would keep all valid information, but changed that policy related to birth names in 2019, instead removing birth names that are not widely and publicly known, of persons who no longer use their birth names.[73] This was done in response to pressure from LGBTQ groups against the publication of the birth names of transgender people without their consent (deadnaming). Any name a person had previously been credited under, however, continues to be maintained in the credits section.[73]
      </div>
    </>
  );
};
